...
export class TrapManager {
    ...
    isTokenOnTrap(token, trapToken) {
        ...
        return !(tokenPos.x > trapPos.x + trapPos.width ||
...
new Dialog({
     ...
     * Trigger a trap by ID
     */
    async triggerTrap(trapId, tokenId) {
        // Get the trap
     ...
     */
    async handleSavingThrow(actor, trap, damage) {
        if (!trap.savingThrow) {
